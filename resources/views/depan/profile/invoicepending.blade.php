...
<div class="section">
	...
	<div class="container">
			                ...
			                <tr role="row" class="odd">
			                	<td>
	                                <div class="text-center image">
	                                  <img width="75" src="{{asset('gambars/'.$produk->gambar)}}">
	                                </div>
			                	</td>
			                    <td>{{ $produk->namaproduk }}</td>
			                	<td>{{ $produk->qty }}</td>
			                    <td>@currency($produk->harga)</td>
			                    <td>@currency($produk->subtotal)</td>
			                </tr>
		        		@endforeach
		            </tbody>
		        </table>
		...
		<div class="col-md-3 order-details">
			<a href="/profile/history/{{ Auth::user()->name }}/{{ Auth::user()->id }}" class="primary-btn order-submit">Back To Profile</a>
		</div>
		<div class="col-md-3 order-details">
		...
		<div class="col-md-3 order-details">
			<a href="/product/checkout/transaction/{{ Auth::user()->id }}" class="primary-btn order-submit">Get PDF</a>
		</div>
	</div>
	<!-- /container -->
</div>
